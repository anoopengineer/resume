...
\begin{resume}
    ...
    \begin{itemize}  \itemsep -2pt %reduce space between items
        ...
        \item Implementing petabyte scale, data centric, mission critical applications.
        \item Building distributed, fault tolerant, scalable platforms.
        \item Driving organizational change to become a talent magnet. Hiring and retaining the best and diverse talent.
        \item Multi domain experience -- consumer electronics, big data, full stack, cloud governance, security, data risk management
        \item Loves coding -- primarily with Python \& Javascript
    \end{itemize}
